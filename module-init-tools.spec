...
%pre
if [ -e %{_sysconfdir}/modprobe.d/blacklist-mdv ]; then
	mv %{_sysconfdir}/modprobe.d/blacklist-mdv{,.conf}
fi
if [ -e %{_sysconfdir}/modprobe.d/blacklist-compat ]; then
	mv %{_sysconfdir}/modprobe.d/blacklist-compat{,.conf}
fi
